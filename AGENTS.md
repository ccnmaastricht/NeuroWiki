# AGENTS.md — NeuroWiki Project Context

This file is loaded automatically by OpenAI Codex at the start of every session.
...
├── AGENTS.md             ← OpenAI Codex context (this file; auto-read on launch)
