# GEMINI.md — NeuroWiki Project Context

This file is loaded automatically by Gemini CLI at the start of every session.
...
├── GEMINI.md             ← Gemini CLI context (this file; auto-read on launch)
